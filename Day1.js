...
let isDifferentWhenLower = name1.toLowerCase() !== name2.toLowerCase();
console.log(isDifferentWhenLower);
*/
...
let x = 1;
let y = 0;
var result = x > y ? resultToPrint ="x is greater than y" : resultToPrint = "x is less than y";
